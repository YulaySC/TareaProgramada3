class PreguntaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @preguntum.save
        format.html { redirect_to @preguntum, notice: 'La pregunta ya está posteada' }
  ...
  def update
    respond_to do |format|
      if @preguntum.update(preguntum_params)
        format.html { redirect_to @preguntum, notice: 'La pregunta fue actualizada' }
  ...
  def destroy
    @preguntum.destroy
    respond_to do |format|
      format.html { redirect_to pregunta_url, notice: 'La pregunta fue eliminada' }
  ...
  private
    ...
    def preguntum_params
      params.require(:preguntum).permit(:titulo, :post, :etiqueta)
    end
end
