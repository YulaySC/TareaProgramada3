...
class PreguntaControllerTest < ActionController::TestCase
  ...
  test "should create preguntum" do
    assert_difference('Preguntum.count') do
      post :create, preguntum: { etiqueta: @preguntum.etiqueta, post: @preguntum.post, titulo: @preguntum.titulo }
    end
  ...
  test "should update preguntum" do
    patch :update, id: @preguntum, preguntum: { etiqueta: @preguntum.etiqueta, post: @preguntum.post, titulo: @preguntum.titulo }
    assert_redirected_to preguntum_path(assigns(:preguntum))
  end
